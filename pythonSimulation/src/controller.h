...
//#define IAC_AMP_MAX_10mA 9.2*100  // 325*9.2/2=1495W should provide 1000W  factor 1.5  25.2.2026: 1.56kW@238Vac,384Vdc
...
_Static_assert(IAC_AMP_MAX_10mA <= E_I_AC_RMS_MAX_AMP_10mA,
"IAC_AMP_MAX_10mA above error limit!");
